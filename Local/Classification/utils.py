    ...
    for i in range(nb_trainings):
        ...
        if pretrained:
            ...
            if parameters[8][i].children[1].value:
                if parameters[11][i].children[1].value:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                    ...
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
            else:
                if parameters[11][i].children[1].value:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                else:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_TL_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
            ...
            if parameters[8][i].children[1].value:
                if parameters[11][i].children[1].value:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                else:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[10][i].children[1].value)+"_"+str(parameters[9][i].children[1].value)+"ep_last_layer"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
            else:
                if parameters[11][i].children[1].value:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[13][i].children[1].value)+"_"+str(parameters[12][i].children[1].value)+"ep_last_block"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                else:
                    if parameters[14][i].children[1].value:
                        model_name = "MNet_"+str(parameters[3][i].children[1].value)+"ch_"+str(parameters[4][i].children[1].value)+"cl_"+str(parameters[5][i].children[1].value)+"_"+str(parameters[6][i].children[1].value)+"_lr_"+str(parameters[16][i].children[1].value)+"_"+str(parameters[15][i].children[1].value)+"ep_whole_network_"+str(parameters[17][i].children[1].value)+"DA_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
                    else:
                        sys.exit("Training #"+str(i+1)+": You need to select a part of the network to train")
